...
class _HomeScreenState extends State<HomeScreen>
{
  ...
  //kunci untuk enskripsi dan deskripsi
  final encrypt.Key _key = encrypt.Key.fromLength(32);

  //Initialization vector untuk enskripsi dan deskripsi
  ...
  void _encryptText(String text)
  {
    try{
      ...
      print('Error encrpyting text: $e,stackTrace: $stackTrace');
    }
  }
  ...
  void _decryptText(String text)
  {
    try {
      ...
      {
        print('Text to decrypted cannot be empty');
      }
    }
    catch (e, stackTrace)
    {
